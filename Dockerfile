...
RUN ln -s /etc/apache2/mods-available/ssl.load /etc/apache2/mods-enabled/ && ln -s /etc/apache2/mods-available/ssl.conf /etc/apache2/mods-enabled/ && ln -s /etc/apache2/mods-available/proxy.load /etc/apache2/mods-enabled/ && ln -s /etc/apache2/mods-available/proxy.conf /etc/apache2/mods-enabled/ && ln -s /etc/apache2/mods-available/socache_shmcb.load /etc/apache2/mods-enabled/ && ln -s /etc/apache2/sites-available/default-ssl.conf /etc/apache2/sites-enabled/ && ln -s /etc/apache2/mods-available/headers.load /etc/apache2/mods-enabled/ && ln -s /etc/apache2/mods-available/proxy_http.load /etc/apache2/mods-enabled/
RUN sed -i 's/ssl-cert-snakeoil.pem/domain.crt/g' /etc/apache2/sites-enabled/default-ssl.conf && sed -i 's/private\/ssl-cert-snakeoil.key/certs\/domain.key/g' /etc/apache2/sites-enabled/default-ssl.conf
